...
```
⚔️  Skald | v0.14.6 — server hook active. /skald-api/* routes ready.
```
...
```json
{"status":"ok","service":"The Eternal Skald","version":"0.14.6"}
```
...
**No `⚔️ Skald | v0.14.6` line in Foundry's console output**
