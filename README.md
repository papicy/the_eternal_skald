...
```
⚔️  Skald | v0.21.0 — server hook active. /skald-api/* routes ready.
```
...
```json
{"status":"ok","service":"The Eternal Skald","version":"0.21.0"}
```
