...
[![Version](https://img.shields.io/badge/version-0.25.1_alpha-gold?style=for-the-badge&labelColor=1a1a1a)](https://github.com/papicy/the_eternal_skald/releases)
...
> [!WARNING]
> **Alpha / Development Version (v0.25.1)** — Experimental pre-release software under active development. Expect rough edges and breaking changes between versions. **Please back up your world before use.**
...
```text
⚔️  Skald | v0.25.1 — server hook active. /skald-api/* routes ready.
```
...
```json
{"status":"ok","service":"The Eternal Skald","version":"0.25.1"}
```
