...
```
⚔️  Skald | v0.17.2 — server hook active. /skald-api/* routes ready.
```
...
```json
{"status":"ok","service":"The Eternal Skald","version":"0.17.2"}
```
